...
module.exports = (_subject, { benchmark }) => {
    ...
    benchmark({
        callback: 'parseIriReference',
        method: 'normalize',
        methodArgs: [{ transform: 'URI' }],
        args: ['https://usér@example.com/a/../café?q=資料#résultat'],
    });
    ...
    benchmark({
        ...
        args: ['https://us%C3%A9r@example.com/a/../caf%C3%A9?q=%E8%B3%87%E6%96%99#r%C3%A9sultat'],
    });
};
