# Unicode 16.0 IDNA conformance fixtures

This concern contains the authoritative Unicode 16.0.0 [`IdnaTestV2.txt`](https://www.unicode.org/Public/idna/16.0.0/IdnaTestV2.txt) conformance vectors and [`IdnaMappingTable.txt`](https://www.unicode.org/Public/idna/16.0.0/IdnaMappingTable.txt) comparison data.
