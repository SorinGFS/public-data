# Unicode 17.0 IDNA conformance fixtures

This concern contains the authoritative Unicode 17.0.0 [`IdnaTestV2.txt`](https://www.unicode.org/Public/17.0.0/idna/IdnaTestV2.txt) conformance vectors and [`IdnaMappingTable.txt`](https://www.unicode.org/Public/17.0.0/idna/IdnaMappingTable.txt) comparison data.
