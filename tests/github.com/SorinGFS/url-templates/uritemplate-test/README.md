...
Original source: [uritemplate-test repo](https://github.com/uri-templates/uritemplate-test)
...
Each test file is a [JSON](https://datatracker.ietf.org/doc/html/rfc8259) document
